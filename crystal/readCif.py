...
#====================================================================
  ...
  def mkVaspMap( self):
    ...
    # For each symbol, create a list of position vectors
    ...
    # Write posvecs to file 'tempplot'. xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
def writePoscar(
  ...
  # Lattice vectors == basis vectors of the unit cell
